...
<img src="http://git.cn-hangzhou.oss-cdn.aliyun-inc.com/uploads/engine-test-platform/xuanwu-op/dee12dfaaefef0f505e6060bac150697/image.png" width="30%" height="30%"></img>
...
![center|image](http://git.cn-hangzhou.oss-cdn.aliyun-inc.com/uploads/engine-test-platform/xuanwu-op/69608a21ebcab8194a1b82360e38e148/image.png)
    
# 教程
- [基础教程](http://gitlab.alibaba-inc.com/engine-test-platform/xuanwu-op/wikis/home)
...
进入xuanwu-op/agent目录，启动agent

`mvn clean package`

`java -jar target/RuleEngine.jar`

进入xuanwu-op/platform，启动platform，完成后即可通过配置的端口号访问（默认访问地址为: ip:9100）
